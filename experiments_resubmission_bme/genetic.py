...
def main():
    ...
    for n_layers_gnn in [1, 2, 3]:
        ...
        dataset = Dataset(
            forward_path=f"../data/processed/torch_data/real_lognorm/data_forward_{cell_line}.pt",
            backward_path=f"../data/processed/torch_data/real_lognorm/data_backward_{cell_line}.pt",
            splits_path=f"../data/processed/splits/genetic/{cell_line}/random/5fold/splits.pt"
        )

        edge_index = torch.load(f"../data/processed/torch_data/real_lognorm/edge_index_{cell_line}.pt")
