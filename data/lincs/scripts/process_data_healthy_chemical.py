...
def main():  
	...
	# DATA_ROOT = "../2022-02-LINCS_Level3/data/"
	# log_handle = open(osp.join(outdir, 'process_data_healthy_lognorm_log.txt'), 'w')
	...
	# use_log=True
	# binarize_genewise_comparing_to_control(inst_info_ctl, matrix_ctl, gene_info, log_handle, outdir, use_log)
	# log_handle.close()

	# DATA_ROOT = "../2022-02-LINCS_Level3/data/"
	# log_handle = open(osp.join(outdir, 'process_data_healthy_lognorm_log_augmented.txt'), 'w')
	# inst_info_ctl, gene_info, matrix_ctl = loads_data(DATA_ROOT, log_handle)
	# inst_info_ctl, matrix_ctl = filter_data_metadata(inst_info_ctl, matrix_ctl, log_handle)
	# stats_control(inst_info_ctl, log_handle)
	# use_log=True
