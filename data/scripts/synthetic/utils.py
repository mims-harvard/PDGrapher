...
def check_similarities(real_data, simulated_data, name):
    ...
    log = open('{}_log.txt'.format(name), 'w')
    ...
    plt.ylabel('Density')
    plt.savefig(f'{name}_histogram_gene_level_means.png')
    plt.close()
    ...
    plt.ylabel('Density')
    plt.savefig(f'{name}_histogram_gene_level_stds.png')
    plt.close()
    ...
    plt.ylabel('Density')
    plt.savefig(f'{name}_histogram_expression_values.png')
    plt.close()
    ...
    plt.ylabel('Density')
    plt.savefig(f'{name}_histogram_sample_medians.png')
    plt.close()
