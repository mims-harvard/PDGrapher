...
for selection_type in ['random', 'cancer_genes', 'cancer_targets']:
	for cell_line in ['MCF7', 'A549']:
		for splits_type in ['random', 'leave-pert-out']:
			...
			#outdir
			outdir = '../experiments/baseline_random_genetic/{}/{}/{}'.format(selection_type, cell_line, splits_type)
			...
			splits = "splits/genetic/{}/{}/5fold/splits.pt".format(cell_line, splits_type)
